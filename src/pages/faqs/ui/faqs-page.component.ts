...
import { FaqStore } from '@features/manage-faqs';
    ...
    <div class="bk-page">
      <div class="bk-page__header">
        <div>
          ...
          <p class="bk-page__subtitle">Gestión de preguntas y respuestas para el chatbot</p>
        </div>
      ...
      <bk-modal [open]="showCreateForm()" title="Crear FAQ" (closed)="showCreateForm.set(false)">
      ...
      <bk-modal [open]="showEditForm()" title="Editar FAQ" (closed)="showEditForm.set(false)">
...
export class FaqsPageComponent implements OnInit {
  ...
  private api = inject(FaqApiService);
