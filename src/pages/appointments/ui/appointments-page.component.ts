...
@Component({
  ...
  template: `
    <div class="bk-page">
      ...
      <bk-modal [open]="showCreateForm()" title="Nueva Cita" (closed)="showCreateForm.set(false)">
      ...
      <bk-modal [open]="showEditForm()" title="Editar Cita" (closed)="showEditForm.set(false)">
...
export class AppointmentsPageComponent implements OnInit {
  protected store = inject(AppointmentStore);
  ...
  readonly columns: DataTableColumn[] = [
    { key: 'DtDate', label: 'Fecha', sortable: true },
    { key: 'VcTime', label: 'Hora' },
    { key: 'VcStatus', label: 'Estado' },
  ];
