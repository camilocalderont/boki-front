...
- **Estado**: Angular Signals (signal, computed, effect) — NO RxJS para estado local
- **Estilos**: CSS custom properties alimentadas por JSON de theming — SIN librerías UI externas
